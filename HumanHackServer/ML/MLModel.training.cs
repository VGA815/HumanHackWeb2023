...
namespace HumanHackServer
{
    public partial class MLModel
    {
        public const string RetrainFilePath =  @"C:\Users\VGA\Downloads\Telegram Desktop\right_data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"priority", @"priority", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Message",outputColumnName:@"Message"))      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"priority",@"Message"}))      
